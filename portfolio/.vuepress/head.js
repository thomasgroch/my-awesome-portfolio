...
module.exports = [
  ...
  // Microsoft
  ['meta', { name: 'application-name', content: info.siteName }],
  ...
  ['link', { rel: 'icon', type: 'image/png', href: '/favicon/android-192x192.png', sizes: '96x96' }],
  ['link', { rel: 'icon', type: 'image/png', href: '/favicon/apple-touch-icon-180x180.png', sizes: '192x192' }],
